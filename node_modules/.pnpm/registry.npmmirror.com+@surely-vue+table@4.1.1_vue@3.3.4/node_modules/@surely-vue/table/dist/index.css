...
:root {
  ...
  --surely-table-border-color: #f0f0f0;
...
.surely-table-body-cell-range-selected:not(.surely-table-cell-inline-edit) {
  background-color: var(--surely-table-primary-color-1);
}
.surely-table-body-cell-range-selected-2:not(.surely-table-cell-inline-edit) {
  background-color: var(--surely-table-primary-color-2);
}
.surely-table-body-cell-range-selected-3:not(.surely-table-cell-inline-edit) {
  background-color: var(--surely-table-primary-color-3);
}
.surely-table-body-cell-range-selected-4:not(.surely-table-cell-inline-edit) {
...
.surely-table-body-cell-range-selected.surely-table-body-cell-range-single-cell {
...
.surely-table-bordered .surely-table-cell:not(.surely-table-body-cell-range-right):not( .surely-table-body-cell-range-single-cell) {
