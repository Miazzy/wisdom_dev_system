...
import type { AppendCellRange, FormatRangeCellTextParams, SelectedRangeItem } from '../hooks/RangeInterface';
...
export interface ColumnType<RecordType = DefaultRecordType> extends ColumnSharedType {
    ...
    valueSetter?: (params: ValueParserParams<RecordType>) => boolean;
...
export interface ColumnGroupType<RecordType = DefaultRecordType> extends Omit<ColumnType<RecordType>, 'dataIndex'> {
