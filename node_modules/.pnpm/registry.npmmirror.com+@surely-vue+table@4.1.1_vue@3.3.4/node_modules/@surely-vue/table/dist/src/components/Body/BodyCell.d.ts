...
import type { KeydownPayload, RangeCell } from '../../hooks/RangeInterface';
...
declare const cellProps: {
    ...
    onKeydown: PropType<(e: KeyboardEvent, payload: KeydownPayload) => void>;
