import {
  require_vue
} from "./chunk-Z32RQFM7.js";
import "./chunk-EKQ5CBNY.js";
import {
  __commonJS,
  __esm,
  __export,
...
// node_modules/.pnpm/registry.npmmirror.com+@intlify+shared@9.0.0/node_modules/@intlify/shared/dist/shared.esm-bundler.js
...
var inBrowser, mark, measure, RE_ARGS, hasSymbol, makeSymbol, generateFormatCacheKey, friendlyJSONstringify, isNumber, isDate, isRegExp, isEmptyObject, _globalThis, getGlobalThis, isArray, isFunction, isString, isBoolean, isSymbol, isObject, isPromise, objectToString, toTypeString, isPlainObject, toDisplayString, RANGE;
...
// node_modules/.pnpm/registry.npmmirror.com+@intlify+message-resolver@9.0.0/node_modules/@intlify/message-resolver/dist/message-resolver.esm-bundler.js
...
var isObject2, pathStateMachine, literalValueRE, cache;
...
// node_modules/.pnpm/registry.npmmirror.com+@intlify+runtime@9.0.0/node_modules/@intlify/runtime/dist/runtime.esm-bundler.js
...
// node_modules/.pnpm/registry.npmmirror.com+@intlify+message-compiler@9.0.0/node_modules/@intlify/message-compiler/dist/message-compiler.esm-bundler.js
...
var errorMessages, CHAR_SP, CHAR_CR, CHAR_LF, CHAR_LS, CHAR_PS, EOF, LITERAL_DELIMITER, ERROR_DOMAIN, ERROR_DOMAIN$1, KNOWN_ESCAPES, generate;
var init_message_compiler_esm_bundler = __esm({
  "node_modules/.pnpm/registry.npmmirror.com+@intlify+message-compiler@9.0.0/node_modules/@intlify/message-compiler/dist/message-compiler.esm-bundler.js"() {
    ...
    EOF = void 0;
    LITERAL_DELIMITER = "'";
    ERROR_DOMAIN = "tokenizer";
    ERROR_DOMAIN$1 = "parser";
...
// node_modules/.pnpm/registry.npmmirror.com+@intlify+core-base@9.0.0/node_modules/@intlify/core-base/dist/core-base.esm-bundler.js
...
__export(core_base_esm_bundler_exports, {
  ...
  DevToolsLabels: () => DevToolsLabels,
  DevToolsPlaceholders: () => DevToolsPlaceholders,
  DevToolsTimelineColors: () => DevToolsTimelineColors,
...
function createCoreContext(options = {}) {
  ...
  if (true) {
    context.__emitter = internalOptions.__emitter != null ? internalOptions.__emitter : void 0;
  }
  return context;
}
...
function translate(context, ...args) {
  ...
  let [format2, targetLocale, message] = resolveMessageFormat(context, key, locale, fallbackLocale, fallbackWarn, missingWarn);
  let cacheBaseKey = key;
  if (!(isString(format2) || isMessageFunction(format2))) {
    if (enableDefaultMsg) {
      format2 = defaultMsgOrKey;
      cacheBaseKey = format2;
    }
  }
  if (!(isString(format2) || isMessageFunction(format2)) || !isString(targetLocale)) {
  ...
  const msg = compileMessageFormat(context, key, targetLocale, format2, cacheBaseKey, errorDetector);
  if (occurred) {
    return format2;
  }
...
function datetime(context, ...args) {
  ...
  if (!formatter) {
    formatter = new Intl.DateTimeFormat(targetLocale, Object.assign({}, format2, overrides));
...
function number(context, ...args) {
  ...
  if (!formatter) {
    formatter = new Intl.NumberFormat(targetLocale, Object.assign({}, format2, overrides));
...
var warnMessages, NOT_REOSLVED, MISSING_RESOLVE_VALUE, _compiler, RE_HTML_TAG, WARN_MESSAGE, defaultOnCacheKey, compileCache, errorMessages2, NOOP_MESSAGE_FUNCTION, isMessageFunction, intlDefined, Availabilities, DevToolsLabels, DevToolsPlaceholders, DevToolsTimelineColors;
...
// node_modules/.pnpm/registry.npmmirror.com+vue-i18n@9.0.0_vue@3.3.4/node_modules/vue-i18n/dist/vue-i18n.cjs.js
var require_vue_i18n_cjs = __commonJS({
  "node_modules/.pnpm/registry.npmmirror.com+vue-i18n@9.0.0_vue@3.3.4/node_modules/vue-i18n/dist/vue-i18n.cjs.js"(exports) {
    ...
    function createComposer(options = {}) {
      ...
      function getCoreContext() {
        return coreBase.createCoreContext({
          ...
          __emitter: shared.isPlainObject(_context) ? _context.__emitter : void 0
        });
      }
      ...
      function __transrateVNode(...args) {
        return wrapWithDeps(
          ...
          () => coreBase.parseTranslateArgs(...args)[0],
          "translate",
      ...
      function __numberParts(...args) {
        return wrapWithDeps(
          ...
          () => coreBase.parseNumberArgs(...args)[0],
          "number format",
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      function __datetimeParts(...args) {
        return wrapWithDeps(
          ...
          () => coreBase.parseDateTimeArgs(...args)[0],
          "datetime format",
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      function tm(key) {
        const messages2 = _messages.value[_locale.value] || {};
        const target = coreBase.resolveValue(messages2, key);
      ...
      function mergeDateTimeFormat(locale2, format2) {
        _datetimeFormats.value[locale2] = Object.assign(_datetimeFormats.value[locale2] || {}, format2);
        _context.datetimeFormats = _datetimeFormats.value;
        coreBase.clearDateTimeFormat(_context, locale2, format2);
      }
      ...
      function mergeNumberFormat(locale2, format2) {
        _numberFormats.value[locale2] = Object.assign(_numberFormats.value[locale2] || {}, format2);
        _context.numberFormats = _numberFormats.value;
        coreBase.clearNumberFormat(_context, locale2, format2);
      }
      composerID++;
    ...
    function convertComposerOptions(options) {
      ...
      if (shared.isPlainObject(options.sharedMessages)) {
        ...
        messages = locales.reduce((messages2, locale2) => {
          ...
          Object.assign(message, sharedMessages[locale2]);
          return messages2;
        }, messages || {});
      }
    ...
    var Translation = {
      ...
      setup(props, context) {
        ...
        return () => {
          ...
          return shared.isString(props.tag) ? vue.h(props.tag, { ...attrs }, children) : shared.isObject(props.tag) ? vue.h(props.tag, { ...attrs }, children) : vue.h(vue.Fragment, { ...attrs }, children);
        };
      }
    };
      ...
      return () => {
        ...
        if (shared.isString(props.format)) {
          ...
          overrides = Object.keys(props.format).reduce((options2, prop) => {
            return slotKeys.includes(prop) ? Object.assign({}, options2, { [prop]: props.format[prop] }) : options2;
          }, {});
        }
    ...
    function useI18n(options = {}) {
      ...
      if (scope === "parent") {
        let composer2 = getComposer$1(i18n, instance);
        if (composer2 == null) {
          {
            shared.warn(getWarnMessage2(
              12
    ...
    var globalExportMethods = ["t", "d", "n", "tm"];
