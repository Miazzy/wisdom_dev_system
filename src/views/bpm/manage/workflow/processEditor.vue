...
<script lang="ts" setup>
  ...
  import CustomContentPadProvider from '@/components/Bpm/package/designer/plugins/content-pad';
  // 自定义左侧菜单（修改 默认任务 为 用户任务）
  import CustomPaletteProvider from '@/components/Bpm/package/designer/plugins/palette';
